...
# ================================================================
    ...
    scenarios_data = {
        ...
        "FTP-Patator": {
            # Port 21, brute force FTP — pattern reconnu
            "destination_port": 21, "flow_duration": 871060.0,
            "total_fwd_packets": 12.0, "total_backward_packets": 8.0,
            "flow_bytes_per_s": 987.5, "flow_packets_per_s": 22.97,
            "average_packet_size": 43.0, "packet_length_mean": 43.0,
            "init_win_bytes_forward": 65535.0, "init_win_bytes_backward": 65535.0,
            "flow_iat_mean": 43553.0, "flow_iat_std": 15234.0,
        },
    }
    ...
    scenario = st.selectbox(
        ...
        ["-- Personnalisé --", "Trafic normal (HTTP)", "DDoS", "DoS Hulk", "FTP-Patator"]
    )
